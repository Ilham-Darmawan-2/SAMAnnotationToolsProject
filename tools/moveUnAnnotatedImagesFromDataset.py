...
# CONFIG
# =====================
FOLDER_A = "datasetsInput/ppeKujangv2-6"     # misal: datasets/images
FOLDER_B = "output/ppeKujangv2"        # misal: datasets/annotations
FOLDER_C = "temp/Kujang/bak"     # misal: datasets/no_xml_images
